...
const RestuarantShimmer = () => {
  return (
    <div role="status" class="max-w-sm animate-pulse">
      <div class="flex items-center justify-center w-full h-48 bg-gray-200 rounded sm:w-96 dark:bg-gray-300">
        <svg
...
export default RestuarantShimmer;
